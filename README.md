...
Based on the [Eleventy Base recipes](https://github.com/11ty/eleventy-base-recipes) repo (see there for additional info on Eleventy usage).
...
* Sample pages and a recipes with tag support
...
```
git clone https://github.com/danurbanowicz/eleventy-netlify-boilerplate.git my-recipes-name
```
